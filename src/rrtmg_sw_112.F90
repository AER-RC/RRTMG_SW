...
INTEGER_B :: KLON, KLEV, KSW, KOVLP, DYOFYR
...
REAL_B :: PCCO2(JPLON,JPLAY)   , PCH4(JPLON,JPLAY)   , PN2O(JPLON,JPLAY)
...
INTEGER_B :: ICLD,ICLDATM, INFLAG, ICEFLAG, LIQFLAG, NMOL, NSTR, ICPR
INTEGER_B :: IK, IMOL, J1, J2, JA, JAE, JL, JK, JMOM, JSW, IB
...
! from mmr to vmr.
   ...
   DO JK = 1, KLEV
      ...
      WKL(2,JK) = pcco2(JL,JK)*amd/amco2
      WKL(3,JK) = pozon(JL,JK)*amd/amo
      WKL(4,JK) = pn2o(JL,JK)*amd/amn2o
      WKL(6,JK) = pch4(JL,JK)*amd/amch4
